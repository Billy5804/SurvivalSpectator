...
execute positioned as @s store result score @e[type=minecraft:armor_stand, limit=1, tag=new] spec_x run data get entity @s Pos[0] 64
...
execute positioned as @s store result score @e[type=minecraft:armor_stand, limit=1, tag=new] spec_z run data get entity @s Pos[2] 64
