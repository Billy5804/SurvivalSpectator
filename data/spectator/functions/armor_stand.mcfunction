...
execute positioned as @s store result score @e[type=minecraft:armor_stand, limit=1, tag=new] ld_x run data get entity @s Pos[0] 0.0625
execute positioned as @s store result score @e[type=minecraft:armor_stand, limit=1, tag=new] ld_z run data get entity @s Pos[2] 0.0625
