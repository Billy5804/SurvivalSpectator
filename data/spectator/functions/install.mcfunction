...
execute unless score .adventureSurvival spec_admin = .adventureSurvival spec_admin run scoreboard players set .adventureSurvival spec_admin 0
...
#execute unless score .spectateDelay spec_admin = .spectateDelay spec_admin run scoreboard players set .spectateDelay spec_admin -1

scoreboard objectives add Spectate trigger

scoreboard objectives add spec_badEffect dummy
