...
execute as @a if score @s specCreative matches 1 run function spectator:creative_toggle
scoreboard players reset @a specCreative
scoreboard players enable @a specCreative
execute if score #bool specCreative matches 1 as @a if entity @s[gamemode=creative] run function spectator:creative_override
